...
module.exports.ipmiSelListOutput = '1,05/27/2014,21:20:43,Event Logging Disabled #0x07,Log area reset/cleared,Asserted\n' +
...
module.exports.ipmiSelOutput = fs
    .readFileSync(__dirname+"/samplefiles/ipmi-sel.txt")
    .toString();
