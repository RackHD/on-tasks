...
function baseJobFactory(
    ...
    BaseJob.prototype._subscribeTaskNotification = function _subscribeTaskNotification(taskId, callback) {
        var self = this;
        var deferred = eventsProtocol.subscribeTaskNotification(taskId, callback.bind(self));
        self.subscriptionPromises.push(deferred);
        return deferred.then(function(subscription) {
            self.subscriptions.push(subscription);
        });
