...
function baseJobFactory(
    ...
    BaseJob.prototype._subscribeTaskNotification = function _subscribeTaskNotification(callback) {
        var self = this;
        var deferred = eventsProtocol.subscribeTaskNotification(callback.bind(self));
        self.subscriptionPromises.push(deferred);
        return deferred.then(function(subscription) {
            self.subscriptions.push(subscription);
        });
