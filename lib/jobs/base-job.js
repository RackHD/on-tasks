...
function baseJobFactory(
    ...
    BaseJob.prototype._subscribeSelEvent = function _subscribeSelEvent(pollerId, nodeId, callback) {
        var self = this;
        var deferred = eventsProtocol.subscribeSelEvent(pollerId, nodeId, callback.bind(self));
        self.subscriptionPromises.push(deferred);
        return deferred.then(function(subscription) {
            self.subscriptions.push(subscription);
        });
