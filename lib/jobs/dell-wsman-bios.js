...
function DellWsmanBiosJobFactory(
    ...
    DellWsmanBiosJob.prototype.initJob = function () {
        ...
        .then(function(obm) {
            ...
            if (!self.dellConfigs || !self.dellConfigs.services.bios) {
            	throw new errors.NotFoundError('Dell Configuration (BIOS) web service is not defined in wsmanConfig.json.');
            }
            var parse = urlParse(self.dellConfigs.services.bios.host);
    ...
    DellWsmanBiosJob.prototype.collectViaCallback = function() {
      	...
      	var rackHdCallback = self.dellConfigs.services.bios.endpoints.callbackUri;
      	...
      	var requestUri = '';
   		requestUri = self.dellConfigs.services.bios.endpoints.biosCallback;
