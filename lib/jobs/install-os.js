...
function installOsJobFactory(
     ...
     */
    InstallOsJob.prototype.updateProgress = function(descript, step) {
        var progressData = {
                ...
                taskProgress: {
                    taskId: this.taskId,
                    progress: {
                        progressRate: step + '/' + this.options.steps,
                        description: descript
                    }
                }
        };
    ...
    InstallOsJob.prototype._run = function() {
        ...
        return Promise.resolve().then(function() {
            ...
            self._subscribeNodeNotification(self.nodeId, function(data) {
                ...
                return self.updateProgress(description, self.options.steps)
                .then(function(){
                    self._done();
                });
            });
