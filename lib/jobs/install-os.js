...
function installOsJobFactory(
     ...
     */
    InstallOsJob.prototype.updateProgress = function(taskDescription, value) {
        var self = this;
        ...
        .then(function(graph){
            ...
            progress.setGraphDescription(taskDescription);
            progress.calculateGraphProgress();
            progress.setTaskProgress(self.taskId, taskProgress);
            progress.calculateTaskProgressPercentage();
            return eventsProtocol.publishProgressEvent(self.context.graphId, progress.getData());
        });
    };
    ...
    InstallOsJob.prototype._run = function() {
        ...
        return Promise.resolve().then(function() {
            ...
            self._subscribeRequestProfile(function() {
                ...
                self.updateProgress(description, 1);
                return self.profile;
            });
            ...
            self._subscribeNodeNotification(self.nodeId, function(data) {
                ...
                self.updateProgress(description, self.options.totalSteps);
                return self._done();
            });
        }).catch(function(err) {
