...
function ipmiJobFactory(
    ...
    IpmiJob.prototype._run = function run() {
        ...
        this._subscribeRunIpmiCommand(this.routingKey, 'selInformation',
                this.ipmiSelInformationCallback);
        ...
        this._subscribeRunIpmiCommand(this.routingKey, 'chassis', this.ipmiChassisCallback);
        this._subscribeRunIpmiCommand(this.routingKey, 'driveHealth',
                this.ipmiDriveHealthCallback);
    };
