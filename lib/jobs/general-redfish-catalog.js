...
function GeneralRedfishCatalogJobFactory(
    ...
    GeneralRedfishCatalogJob.prototype._run = function () {
        var self = this;
        return self.catalogSystemEndpoints(self.systems)
            .then(function () {
                return self.catalogChassisEndpoints(self.chassis);
            })
            .then(function () {
                self._done();
            })
    ...
    GeneralRedfishCatalogJob.prototype.catalogChassisEndpoints = function (chassis) {
        var self = this;
        return Promise.resolve(chassis)
            .each(self.catalogEndpoints.bind(self))
    };

    GeneralRedfishCatalogJob.prototype.catalogSystemEndpoints = function (systems) {
        var self = this;
