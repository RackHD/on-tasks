...
)
{
	...
	PowerThermalTool.prototype.initJob = function () {
		...
		if (!self.dellConfigs || !self.dellConfigs.services.powerThermalMonitoring) {
			throw new errors.NotFoundError('Dell web service configuration is not defined in wsmanConfig.json.');
		}
