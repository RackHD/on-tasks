...
function taskGraphFactory(
    ...
    TaskGraph.prototype.updateGraphProgress = function(nodeId, progressData) {
        assert.string(progressData.graphName); 
        ...
        .then(function(_progressData){
            if (_.has(_progressData, "taskProgress.graphId")) {
                _.omit( _progressData, "taskProgress.graphId");
            }
            return taskMessenger.publishProgressEvent(nodeId, _progressData);
        });
    };
