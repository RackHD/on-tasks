...
function DellWsmanObmServiceFactory(
    ...
    DellWsmanObmService.prototype.powerStatus = function() {
        ...
        .then(function() {
            ...
            if (!dell || !dell.services.inventory) {
            	throw new Error('Dell Inventory web service is not defined in smiConfig.json.');
            }
            
            var wsman = new WsmanTool(dell.gateway, {
    ...
    DellWsmanObmService.prototype.run = function (options) {
        ...
        if (!dell || !dell.services.action) {
            throw new Error('Dell ACTION web service is not defined in smiConfig.json.');
        }
