...
function vmrunObmServiceFactory(Q, BaseObmService) {
    ...
    VmrunObmService.prototype.reboot = function() {
        ...
        return self.validate().then(function () {
            return self.run({
                command: fusionPath, args: ['-T', 'fusion', 'reset', self.vmxpath]
            });
        });
    };
    ...
    VmrunObmService.prototype.powerOn = function() {
        ...
        return self.validate().then(function () {
            return self.run({
                command: fusionPath,
                args: ['-T', 'fusion', 'start', self.vmxpath],
                retries: undefined,
                delay: 255
            });
        });
    ...
    VmrunObmService.prototype.powerOff = function() {
        ...
        return self.validate().then(function () {
            return self.run({
                command: fusionPath,
                args: ['-T', 'fusion', 'stop', self.vmxpath],
                retries: undefined,
                delay: 255
            });
        });
    ...
    VmrunObmService.prototype.powerStatus = function() {
        ...
        return self.validate().then(function () {
            return self.run({
                command: fusionPath,
                args: ['-T', 'fusion', 'vprobeVersion',  self.vmxpath],
                retries: undefined,
                delay: 255
