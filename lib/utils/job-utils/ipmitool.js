...
function ipmitoolFactory(Q) {
    ...
    */
    ...
    /**
     * Returns a promise with the results or errors of invoking -v sdr
     *
     * @param host
     * @param user
     * @param password
     ...
     * @param password
     */
    Ipmitool.prototype.selList = function(host, user, password) {
        return this.runCommand(host, user, password, "sel list");
    };
