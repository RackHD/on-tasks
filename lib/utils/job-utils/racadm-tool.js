...
function racadmFactory(
     ...
     * @param {string} user
     * @param {string} password
     * @return {string} jobId -  latest job id in job queue
     */
     ...
     * @param {string} user
     * @param {string} password
     * @returns {object} - all iDRAC configure info in jsonn format
     */
        ...
        return Promise.resolve()
            ...
            .then(function(){
                fs.exists(filePath, function(exist){
                    if(!exist) {
                        throw new Error('File /tmp/idra_configure.xml does not exist');
                    }
                });
            })
            .then(function(){
