...
function parseSensorsDataFactory(assert, _) {
    ...
    function _parseSensorsData(sensorsData) {
    ...
    function parseSdrData(sdrData) {
        var parsed = _parseSensorsData(sdrData);
    ...
    return {
        ...
        _parseSensorsData: _parseSensorsData,
        _processSensor: _processSensor,
        _getSensorType: _getSensorType
    };
}
