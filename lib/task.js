...
function factory(taskProtocol, eventsProtocol, Logger, assert, Errors, constants,
    ...
    var RUNNING = constants.TaskStates.RUNNING;
    var SUCCEEDED = constants.TaskStates.SUCCEEDED;
    var FAILED = constants.TaskStates.FAILED;
    var CANCELLED = constants.TaskStates.CANCELLED;
    var TIMEOUT = constants.TaskStates.TIMEOUT;
    var PENDING = constants.TaskStates.PENDING;
    ...
    function Task(definition, taskOverrides, context) {
        ...
        self.successStates = [SUCCEEDED];
        // hint to whatever is running the task when it has failed
        self.failedStates = [FAILED, TIMEOUT, CANCELLED];
