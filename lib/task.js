...
function factory(
    ...
    function Task(definition, taskOverrides, context) {
        ...
        self.renderContext.api.baseHttps = self.renderContext.api.httpsServer + '/api/current';
        self.renderContext.api.files = self.renderContext.api.base + '/files';
        self.renderContext.api.filesHttps = self.renderContext.api.baseHttps + '/files';
